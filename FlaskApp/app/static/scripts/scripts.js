...
function animate_solution_helper(move)
{
	...
	if (s1-s2 == -1)
	{
		$("#p"+s1).delay(time).animate({marginLeft: "+=10.1%"}, {duration: 1000});
		$("#p"+s2).delay(time+1000).fadeOut({duration: 1000}, function(){$(this).remove()});
		$("#p"+s3).delay(time).animate({marginLeft: "-=10.1%"}, {duration: 1000});
	}
	...
	else if (s1-s2 < 0)
	{
		...
		$("#p"+s1).delay(time).animate({marginTop: "+=10.1%"}, {duration: 1000});
		$("#p"+s2).delay(time+1000).fadeOut({duration: 1000}, function(){$(this).remove()});
		$("#p"+s3).delay(time).animate({marginTop: "-=10.1%"}, {duration: 1000});
	}
